...
session_start();
require_once("utility/db_connect.php");
...
if(isset($_POST['registrazione'])){
    ...
    if(!$conn->query($query)){
        ...
        $messaggio = "Errore nelle registrazione";
        exit();
    }
    else{
...
<div class="login-container">
    <form action="registrazione.php" class="form-login" method="post" enctype="multipart/form-data">
        <ul class="login-nav">
        ...
        <button class="login__submit" type="submit">Registrati</button>
        <div class="errore" style="display: none;">
            <span>Credenziali Errate</span>
        </div>

        <?php
            if(isset($messaggio) && $messaggio != "no") echo '<div class="errore">
                                            <span>' . $messaggio . '</span>
                                        </div>';

            if(isset($messaggio) && $messaggio == "no") echo '<div class="successo">
